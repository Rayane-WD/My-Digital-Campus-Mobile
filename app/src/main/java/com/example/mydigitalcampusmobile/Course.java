    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (user_mail.length()>0 && user_pass.length()>0){login(user_mail, user_pass);}
                else {
                    Toast.makeText(LoginPageActivity.this, "Un champ a été oublié", Toast.LENGTH_SHORT).show();
        ...
        docRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    Log.w("Erreur firebase", "Impossible de se connecter à FireBase : " + task.getException());
                    progressDialog.dismiss();
                }
            }
        });
